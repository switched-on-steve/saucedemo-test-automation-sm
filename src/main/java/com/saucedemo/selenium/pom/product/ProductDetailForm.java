...
public class ProductDetailForm extends ProductForm {
    ...
    public void removeProduct(String removeText) {
        if (addRomoveButton.getText().toLowerCase().equals(removeText.toLowerCase())) addRomoveButton.click();
    }

    public void addProduct(String addText) {
        if (addRomoveButton.getText().toLowerCase().equals(addText.toLowerCase())) addRomoveButton.click();
    }
